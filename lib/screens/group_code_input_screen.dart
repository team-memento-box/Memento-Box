...
class GroupCodeInputScreen extends StatefulWidget {
  const GroupCodeInputScreen({super.key});

  @override
  State<GroupCodeInputScreen> createState() => _GroupCodeInputScreenState();
}

class _GroupCodeInputScreenState extends State<GroupCodeInputScreen> {
    ...
    try {
      ...
      if (checkResponse.statusCode == 200) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('유효하지 않은 가족 코드입니다.')));
      }
    } catch (e) {
      ScaffoldMessenger.of(
        context,
  ...
  Widget _buildSubmitButton() {
    return Positioned(
      ...
      child: GestureDetector(
        onTap: isCodeEntered ? _submitFamilyCode : null,
        child: Container(
          height: 60,
